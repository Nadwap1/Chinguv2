              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <View style={styles.titleRow}>
                    <Text style={[styles.lvlNum, active && { color: "#fff" }]}>Level {lvl.id}</Text>
                    <Text style={[styles.lvlName, active && { color: "#fff" }]}>{lvl.name}</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  lvlNum: { color: "#7A6E91", fontSize: 12, fontWeight: "700" },
  lvlName: { color: "#fff", fontSize: 16, fontWeight: "800" },
